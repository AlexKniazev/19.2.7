...
def test_add_new_pet_with_valid_data(name='Лапуля', animal_type='терьер',
                                     age='1', pet_photo='images/1_Лапуля.jpg'):
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Рекс", "овчарка", "2", "images/2_Рекс.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_add_new_pet_with_not_valid_data(name='', animal_type='123',
                                     age='asd', pet_photo='images/4.jpg'):
...
def test_add_photo_of_pet_incorrect_format(pet_photo='images/6.webp'):
...
def test_add_photo_of_pet_incorrect_pet_id(pet_photo='images/5.jpg'):
